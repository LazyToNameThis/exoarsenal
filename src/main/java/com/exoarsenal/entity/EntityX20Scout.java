...
import com.exoarsenal.entity.scout.ScoutAnimationRules;
...
public final class EntityX20Scout extends EntityMob implements IAnimatable {
    ...
    public void onLivingUpdate() {
        ...
        if (!balanceApplied) {
            ...
            if (!difficultyChosen) {
                com.exoarsenal.world.ExoArsenalWorldSettings settings =
                        com.exoarsenal.world.ExoArsenalWorldSettings.get(world);
    ...
    private void tickScene() {
        ...
        if (scene == 8) {
            ...
            if (tick == com.exoarsenal.client.ScoutEntrance.DIALOGUE)
            ...
            if (tick == 64 || tick == 82)
                world.playSound(
                        ...
                        1.2F,
                        .7F);
            if (tick >= com.exoarsenal.client.ScoutEntrance.END) {
    ...
    private void tickScissorHunt(int tick, EntityLivingBase target) {
        ...
        if (tick == 148) {
            com.exoarsenal.network.PacketScoutImpact.send(this, getHammerPosition(), 3);
            dataManager.set(HAMMER_FLIGHT, 6);
            spawnRecall(getHammerPosition(), 12);
        }
    ...
    private void startHexWave() {
        ...
        waveAge = 0;
        waveVictims.clear();
        com.exoarsenal.network.PacketScoutImpact.send(this, waveCenter.addVector(0, .2, 0), 1);
    ...
    private void impact(Vec3d p, int count) {
        com.exoarsenal.network.PacketScoutImpact.send(this, p, count >= 24 ? 1 : 0);
    }
        ...
        if (tag.hasKey("ScoutDefeatTick")) {
            ...
            dataManager.set(
                    ...
                    Math.max(
                            0,
                            Math.min(
                                    com.exoarsenal.client.ScoutDefeatPose.END - 1,
    ...
    protected void onDeathUpdate() {
        ...
        if (!world.isRemote) {
            ...
            if (world instanceof WorldServer
                    && t >= com.exoarsenal.client.ScoutDefeatPose.ESCAPE_START
                    && t % 2 == 0) {
                float y = com.exoarsenal.client.ScoutDefeatPose.pilotHeight(t);
                float z = com.exoarsenal.client.ScoutDefeatPose.pilotDepth(t);
                float x = com.exoarsenal.client.ScoutDefeatPose.pilotSide(t);
            ...
            if (t >= com.exoarsenal.client.ScoutDefeatPose.END) {
                deathTime = 19;
                super.onDeathUpdate();
            }
        }
