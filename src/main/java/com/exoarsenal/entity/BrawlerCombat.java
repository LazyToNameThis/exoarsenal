...
import static com.exoarsenal.entity.BrawlerScore.Pattern;
...
final class BrawlerCombat {
    ...
    private void grab(EntityLivingBase target) {
        if (!(target instanceof EntityPlayer)
                ...
                || com.exoarsenal.combat.WeaponCombat.dodgeReady((EntityPlayer) target)) return;
    ...
    private EntityBrawlerEffect liftTerrain(Vec3d at, float size, int life) {
        ...
        com.exoarsenal.world.ExcavatorTerrain journal =
