...
public abstract class EntityWulfrumEye extends EntityMob implements IAnimatable {
    ...
    public void onDeath(DamageSource source) {
        ...
        if (!world.isRemote
            ...
            if (expert) {
                dropItem(com.exoarsenal.registry.MachineRewards.SEER_BAG, 1);
                return;
            }
            WulfrumEncounterLoot reward = WulfrumEncounterLoot.roll(rand, expert);
            entityDropItem(
                    new net.minecraft.item.ItemStack(
                            com.exoarsenal.expedition.WulfrumArsenal.SCRAP, reward.scrap),
                    0);
            entityDropItem(
                    new net.minecraft.item.ItemStack(
                            com.exoarsenal.expedition.ExpeditionContent.CORE, reward.cores),
                    0);
            entityDropItem(
                    com.exoarsenal.expedition.WulfrumArsenal.charged(
                            com.exoarsenal.expedition.WulfrumArsenal.AWL),
                    0);
            entityDropItem(
                    com.exoarsenal.expedition.WulfrumArsenal.charged(
                            com.exoarsenal.expedition.WulfrumArsenal.LITTLE_BOY),
                    0);
            if (reward.heart)
                entityDropItem(
                        new net.minecraft.item.ItemStack(
                                com.exoarsenal.expedition.WulfrumArsenal.HEART),
                        0);
        }
    }
