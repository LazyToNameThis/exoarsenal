...
import com.exoarsenal.client.model.X20ScoutModel;
    ...
    public void renderRecursively(
        ...
        if (!bone.isHidden() && !wing)
            for (GeoCube cube : bone.childCubes) {
                ...
                boolean skin = com.exoarsenal.client.PilotColors.applies(name);
                ...
                int material = com.exoarsenal.client.PilotColors.color(name);
                int tint =
                        com.exoarsenal.client.RobotColors.color(name, energy && attackLight > .35F);
                renderCube(
                        buffer,
                        cube,
