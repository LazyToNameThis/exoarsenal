...
public final class BrawlerClient {
    ...
    public static void models(ModelRegistryEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(
                ...
                manager ->
                        new Render<com.exoarsenal.entity.EntityBrawlerArm>(manager) {
                            @Override
                            protected ResourceLocation getEntityTexture(
                                    com.exoarsenal.entity.EntityBrawlerArm arm) {
                                return null;
                            }
                        });
    }
    ...
    static {
        BrawlerModel.rebuild(HEAD, FIST, CLEAVER, HARPOON, PROJECTOR, FLAIL);
    }
    ...
    public static ExpeditionMesh articulatedDriver(float grip) {
        return BrawlerModel.driverPose(grip);
    }
    ...
    public static int skinPart(ExpeditionMesh mesh) {
        return mesh == HEAD
                ? 0
                : mesh == FIST || BrawlerModel.driverMesh(mesh)
                        ? 1
                        : mesh == CLEAVER
                                ? 2
                                : mesh == HARPOON
    ...
    private static void cleaverTrail(EntityBrawler boss, float partial) {
        ...
        if (boss.aerialAttack() >= 0
                && !com.exoarsenal.entity.BrawlerAerialScore.cleaverAttached(
                        com.exoarsenal.entity.BrawlerAerialScore.decode(boss.aerialAttack()), now))
            return;
        if (boss.phase() != 1
                || boss.armHealth(1) <= 0
                || boss.transition() > 0
    ...
    private static void aerialPressure(EntityBrawler e, float partial) {
        if (e.aerialAttack()
                != com.exoarsenal.entity.BrawlerAerialScore.Attack.MACH_CLEAVER.ordinal()) return;
        ...
        if (e.phase() == 2)
            for (int socket = 0; socket < 4; socket++) {
                ...
                if ((e.engineMask() & (1 << (socket + 1))) != 0) {
                    ...
                    com.exoarsenal.client.render.WulfrumFire.emit(
                            b,
                            from,
    ...
    private static final class BrawlerRenderer extends Render<EntityBrawler> {
        ...
        public void doRender(
            ...
            if (e.bipedal()) {
                com.exoarsenal.entity.BrawlerMartialPose pose = e.martialPose(partial);
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (e.clashTick() > 0 && i == e.clashArm() || e.introTick() >= 140 && i == 0) {
                    double recoil =
                            e.clashTick() > 0
                                    ? com.exoarsenal.entity.BrawlerClash.returned(
                                            e.clashTick() + partial)
                                    : 0;
                    wrist =
                            new double[] {
                ...
                boolean held =
                        e.bipedal()
                                || (e.aerialAttack() >= 0
                                        ? (i != 1
                                                || com.exoarsenal.entity.BrawlerAerialScore
                                                        .cleaverAttached(
                                                                com.exoarsenal.entity
            ...
            for (int indicator = 0;
                ...
                if (e.limiterAttack() >= 0)
                    cue =
                            e.aerialRecovery() > 0
                                    ? 0
                                    : com.exoarsenal.entity.BrawlerLimiterScore.cue(
                                            com.exoarsenal.entity.BrawlerLimiterScore.decode(
                                                    e.limiterAttack()),
                                            e.clock() + partial);
                if (e.aerialAttack() >= 0)
                    cue =
                            e.aerialRecovery() > 0
                                    ? 0
                                    : com.exoarsenal.entity.BrawlerAerialScore.cue(
                                            com.exoarsenal.entity.BrawlerAerialScore.decode(
                                                    e.aerialAttack()),
                                            e.clock() + partial,
                                            hand);
                if (e.bipedal())
                    cue =
                            e.transition() > 0
                                    ? 0
                                    : com.exoarsenal.entity.BrawlerMartialScore.cue(
                                            com.exoarsenal.entity.BrawlerMartialScore.decode(
                                                    Math.max(0, e.martialAttack())),
                                            hand,
                                            e.clock() + partial);
                if (hand == 1
                        && e.clashTick() == 0
                    ...
                    for (int c = 0; c < cells; c++) {
                        ...
                        double shieldRadius =
                                e.phase() == 2 && e.transition() > 0
                                        ...
                                        : 2.05;
                        if (e.aerialAttack()
                                == com.exoarsenal.entity.BrawlerAerialScore.Attack.TESLA_CAGE
                                        .ordinal())
                            shieldRadius +=
                                    .85
    ...
    private static void biped(EntityBrawler e, float partial) {
        com.exoarsenal.entity.BrawlerMartialPose p = e.martialPose(partial);
