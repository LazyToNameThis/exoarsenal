                    ...
                    event.getMap()
                            .registerSprite(
                                    new ResourceLocation(
                                            ExoArsenal.MODID, "particle/ice_flash_" + i));
        SHARD[0] =
                event.getMap()
                        .registerSprite(
                                new ResourceLocation(ExoArsenal.MODID, "particle/ice_shard"));
        WISP[0] =
                event.getMap()
                        .registerSprite(
                                new ResourceLocation(ExoArsenal.MODID, "particle/frost_wisp"));
    }
