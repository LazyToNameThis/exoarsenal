...
public class X10BladeModel extends RBladeModel {
    @Override
    public ResourceLocation getModelLocation(com.exoarsenal.item.ItemRBlade object) {
        return new ResourceLocation(ExoArsenal.MODID, "geo/x10_blade_refined.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(com.exoarsenal.item.ItemRBlade object) {
        return new ResourceLocation(ExoArsenal.MODID, "textures/models/armor/x10_refined_100.png");
    }

    @Override
    public void setLivingAnimations(
            com.exoarsenal.item.ItemRBlade blade, Integer id, AnimationEvent event) {
        ...
        if (mc.world != null)
            for (net.minecraft.entity.player.EntityPlayer owner : mc.world.playerEntities) {
                ...
                com.exoarsenal.combat.WeaponDiscipline d =
                        com.exoarsenal.combat.WeaponDiscipline.of(stack);
                float age =
                ...
                if (age < contact - 3)
                    open =
                            17
                                    + 18
                                            * com.exoarsenal.client.CombatMotion.smooth(
                ...
                if (age >= contact && age < contact + 5)
                    compression =
                            -0.9F * com.exoarsenal.client.CombatMotion.recoil((age - contact) / 5);
                break;
            }
