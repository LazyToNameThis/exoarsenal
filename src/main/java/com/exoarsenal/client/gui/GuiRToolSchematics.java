...
import com.exoarsenal.network.PacketRequestSchematics;
import com.exoarsenal.network.PacketSelectSchematic;
...
public class GuiRToolSchematics extends GuiScreen {
    ...
    private ItemStack heldTool() {
        ...
        if (main.getItem() instanceof com.exoarsenal.item.ItemRTool) return main;
        ItemStack off = mc.player.getHeldItemOffhand();
        return off.getItem() instanceof com.exoarsenal.item.ItemRTool ? off : ItemStack.EMPTY;
    }
}
