...
public final class ExoArsenalWorldSettings extends WorldSavedData {
    private static final String KEY = "exoarsenal_difficulty";
    ...
    public ExoArsenalWorldSettings() {
        super(KEY);
    }

    public ExoArsenalWorldSettings(String name) {
        super(name);
    }

    public static ExoArsenalWorldSettings get(World world) {
        World overworld = world.getMinecraftServer().getWorld(0);
        ExoArsenalWorldSettings data =
                (ExoArsenalWorldSettings)
                        overworld.getMapStorage().getOrLoadData(ExoArsenalWorldSettings.class, KEY);
        if (data == null) {
            data = new ExoArsenalWorldSettings();
