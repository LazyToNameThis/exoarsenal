...
public final class ModBiomes {
    ...
    private static Biome biome(String id, String name, float height, float variation) {
        ...
        biome.setRegistryName(ExoArsenal.MODID, id);
        biome.topBlock = com.exoarsenal.registry.ModContent.PERMAFROST.getDefaultState();
        biome.fillerBlock = com.exoarsenal.registry.ModContent.FROZEN_STONE.getDefaultState();
