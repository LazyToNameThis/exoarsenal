...
public final class ExpeditionClient {
    ...
    public static void models(ModelRegistryEvent e) {
        ...
        for (Item item : ExpeditionContent.ITEMS) {
            ...
            ModelLoader.setCustomModelResourceLocation(
                    ...
                    new ModelResourceLocation(
                            ExoArsenal.MODID + (gun ? ":expedition_gun" : ":expedition_item"),
                            "inventory"));
            item.setTileEntityItemStackRenderer(renderer);
        }
        RenderingRegistry.registerEntityRenderingHandler(
                com.exoarsenal.entity.EntityDraedon.class, DraedonRenderer::new);
        ...
        ModelLoader.setCustomModelResourceLocation(
                crystal,
                0,
                new ModelResourceLocation(ExoArsenal.MODID + ":expedition_item", "inventory"));
