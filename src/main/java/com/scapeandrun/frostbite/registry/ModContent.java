...
import com.scapeandrun.frostbite.block.BlockClimateStabilizer;
import com.scapeandrun.frostbite.block.BlockFrozenLog;
import com.scapeandrun.frostbite.block.BlockFrozenStone;
import com.scapeandrun.frostbite.block.BlockPermafrost;
import com.scapeandrun.frostbite.block.BlockPotteryKiln;
import com.scapeandrun.frostbite.block.BlockRecoveryFarmland;
...
public final class ModContent {
    ...
    public static final CreativeTabs TAB =
            new CreativeTabs(Frostbite.MODID) {
                @Override
    ...
    public static final Item FLINT_KNIFE =
            named(new com.scapeandrun.frostbite.item.ItemFlintKnife(), "flint_knife")
                    .setCreativeTab(TAB);
    ...
    public static final Item UNFIRED_CLAY_CAST =
            named(new com.scapeandrun.frostbite.item.ItemUnfiredCast(), "unfired_clay_cast")
                    .setCreativeTab(TAB);
    public static final Item CLAY_CAST =
            named(new com.scapeandrun.frostbite.item.ItemMoldedCast(false), "clay_cast")
                    .setCreativeTab(TAB);
    public static final Item UNFIRED_FIRECLAY_CAST =
            named(new com.scapeandrun.frostbite.item.ItemUnfiredCast(), "unfired_fireclay_cast")
                    .setCreativeTab(TAB);
    public static final Item FIRECLAY_CAST =
            named(new com.scapeandrun.frostbite.item.ItemMoldedCast(true), "fireclay_cast")
                    .setCreativeTab(TAB);
    ...
    public static final Item CLAY_RIVER_PAN =
            named(new com.scapeandrun.frostbite.item.ItemClayRiverPan(), "clay_river_pan")
                    .setCreativeTab(TAB);
    ...
    public static final Item DESERT_MEDALLION =
            tabbed(new com.scapeandrun.frostbite.item.ItemDesertMedallion(), "desert_medallion");
    public static final Item DESERT_SCOURGE_BAG =
            tabbed(new com.scapeandrun.frostbite.item.ItemDesertScourgeBag(), "desert_scourge_bag");
    public static final Item SUSPICIOUS_CONTROLLER =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemSuspiciousController(),
                    "suspicious_controller");
    public static final Item SCOUT_ENERGY_CORE =
            tabbed(new com.scapeandrun.frostbite.item.ItemScoutEnergyCore(), "scouts_energy_core");
    public static final Item SCOUT_TREASURE_BAG =
            tabbed(new com.scapeandrun.frostbite.item.ItemScoutTreasureBag(), "scout_treasure_bag");
    ...
    public static final com.scapeandrun.frostbite.item.ItemScoutWeapon SCOUT_PINCER =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemScoutWeapon(
                            com.scapeandrun.frostbite.item.ItemScoutWeapon.Type.PINCER),
                    "scouts_pincer");
    public static final com.scapeandrun.frostbite.item.ItemScoutWeapon MODIFIED_RAILGUN =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemScoutWeapon(
                            com.scapeandrun.frostbite.item.ItemScoutWeapon.Type.RAILGUN),
                    "modified_railgun");
    public static final com.scapeandrun.frostbite.item.ItemScoutWeapon GLACIER_SMASHER =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemScoutWeapon(
                            com.scapeandrun.frostbite.item.ItemScoutWeapon.Type.SMASHER),
                    "glacier_smasher");
    public static final com.scapeandrun.frostbite.item.ItemScoutWeapon AURORA_BOREALIS =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemScoutWeapon(
                            com.scapeandrun.frostbite.item.ItemScoutWeapon.Type.AURORA),
                    "aurora_borealis");
    public static final com.scapeandrun.frostbite.item.ItemRBlade R_BLADE =
            tabbed(new com.scapeandrun.frostbite.item.ItemRBlade(), "prototype_r_blade");
    public static final com.scapeandrun.frostbite.item.ItemRTool R_TOOL =
            tabbed(new com.scapeandrun.frostbite.item.ItemRTool(), "prototype_r_tool");
    public static final com.scapeandrun.frostbite.item.ItemX10Blade X10_BLADE =
            tabbed(new com.scapeandrun.frostbite.item.ItemX10Blade(), "x10_energy_blade");
    public static final com.scapeandrun.frostbite.item.ItemX10Multitool X10_MULTITOOL =
            tabbed(new com.scapeandrun.frostbite.item.ItemX10Multitool(), "x10_multitool");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun PROTOTYPE_ENERGY_SHOTGUN =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.PROTOTYPE_SHOTGUN),
                    "prototype_energy_shotgun");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun PROTOTYPE_ENERGY_CANNON =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.PROTOTYPE_CANNON),
                    "prototype_energy_cannon");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun PROTOTYPE_ENERGY_PISTOL =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.PROTOTYPE_PISTOL),
                    "prototype_energy_pistol");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun PROTOTYPE_LASER_MACHINEGUN =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.PROTOTYPE_MACHINEGUN),
                    "prototype_laser_machinegun");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun X10_ENERGY_SHOTGUN =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.X10_SHOTGUN),
                    "x10_energy_shotgun");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun X10_ENERGY_CANNON =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.X10_CANNON),
                    "x10_energy_cannon");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun X10_ENERGY_MACHINEGUN =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.X10_MACHINEGUN),
                    "x10_energy_machinegun");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun X10_ENERGY_NET_LAUNCHER =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.X10_NET_LAUNCHER),
                    "x10_energy_net_launcher");
    public static final com.scapeandrun.frostbite.item.ItemEnergyShield PROTOTYPE_ENERGY_SHIELD =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyShield(false),
                    "prototype_energy_shield");
    public static final com.scapeandrun.frostbite.item.ItemEnergyShield X10_ENERGY_SHIELD =
            tabbed(new com.scapeandrun.frostbite.item.ItemEnergyShield(true), "x10_energy_shield");
    public static final com.scapeandrun.frostbite.item.ItemKXBlade KX20_BLADE =
            tabbed(new com.scapeandrun.frostbite.item.ItemKXBlade(), "kx20_fluxuated_blade");
    public static final com.scapeandrun.frostbite.item.ItemKXMultitool KX20_MULTITOOL =
            tabbed(new com.scapeandrun.frostbite.item.ItemKXMultitool(), "kx20_multitool");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun KX20_SHOTGUN =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.KX_SHOTGUN),
                    "kx20_fluxuated_shotgun");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun KX20_TRIBOW =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.KX_TRIBOW),
                    "kx20_tribow");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun KX20_MINIGUN =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.KX_MINIGUN),
                    "kx20_minigun");
    public static final com.scapeandrun.frostbite.item.ItemEnergyGun KX20_RAILGUN =
            tabbed(
                    new com.scapeandrun.frostbite.item.ItemEnergyGun(
                            com.scapeandrun.frostbite.item.ItemEnergyGun.Type.KX_RAILGUN),
                    "kx20_railgun");

    public static final Item CANVAS_HELMET =
            armor(
                    new com.scapeandrun.frostbite.item.ItemCanvasArmor(
    ...
    public static final Item RMOR_HELMET =
            armor(
                    new com.scapeandrun.frostbite.item.ItemRmorArmor(
    ...
    public static final Item X10_HELMET =
            armor(
                    new com.scapeandrun.frostbite.item.ItemX10Armor(
    ...
    public static final Item KX20_HELMET =
            armor(
                    new com.scapeandrun.frostbite.item.ItemKXArmor(
    ...
    private static <T extends Block> T named(T value, String name) {
        value.setRegistryName(Frostbite.MODID, name)
    ...
    public static void items(RegistryEvent.Register<Item> event) {
        ...
        event.getRegistry()
                .register(
                        new com.scapeandrun.frostbite.item.ItemBlockRecoverySoil(FROSTBITTEN_SOIL)
                                .setRegistryName(FROSTBITTEN_SOIL.getRegistryName()));
        event.getRegistry()
                .register(
                        new com.scapeandrun.frostbite.item.ItemBlockRecoverySoil(RECOVERY_FARMLAND)
