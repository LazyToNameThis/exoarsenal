...
public final class FrostbiteDifficultyCommand extends CommandBase {
    @Override
    ...
    public java.util.List<String> getAliases() {
        return java.util.Collections.singletonList("frostbiteexpert");
    }
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args)
        ...
        FrostbiteWorldSettings settings = FrostbiteWorldSettings.get(sender.getEntityWorld());
