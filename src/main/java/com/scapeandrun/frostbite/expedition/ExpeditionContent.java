...
public final class ExpeditionContent {
    ...
    static Item register(Item item, String name) {
        item.setRegistryName(Frostbite.MODID, name)
    ...
    static Block register(Block block, String name) {
        block.setRegistryName(Frostbite.MODID, name)
                .setUnlocalizedName(Frostbite.MODID + "." + name)
                .setCreativeTab(ModContent.TAB);
        BLOCKS.add(block);
        return block;
    ...
    private static void recipe(RegistryEvent.Register<IRecipe> e, Item out, Object... pattern) {
        e.getRegistry()
                .register(
                        new ShapedOreRecipe(
                                        new ResourceLocation(Frostbite.MODID, "expedition"),
                                        new ItemStack(out),
                                        pattern)
        ...
        e.getRegistry()
                .register(
                        new ShapelessOreRecipe(
                                        ...
                                        PRISM_SHARD,
                                        PRISM_SHARD)
                                .setRegistryName(Frostbite.MODID, "sea_prism"));
