...
public final class ExpeditionModule {
    public static void preInit(Frostbite mod) {
        EntityRegistry.registerModEntity(
                new ResourceLocation(Frostbite.MODID, "draedon"),
                com.scapeandrun.frostbite.entity.EntityDraedon.class,
                "draedon",
                150,
                mod,
                160,
        ...
        GameRegistry.registerTileEntity(
                ...
                new ResourceLocation(Frostbite.MODID, "life_crystal_formation"));
        GameRegistry.registerTileEntity(
                ShiverthornBlock.HerbTile.class,
                new ResourceLocation(Frostbite.MODID, "shiverthorn_plant"));
        ...
        EntityRegistry.registerModEntity(
                new ResourceLocation(Frostbite.MODID, "expedition_shot"),
                ...
                true);
        EntityRegistry.registerModEntity(
                new ResourceLocation(Frostbite.MODID, "expedition_minion"),
        ...
        EntityRegistry.registerModEntity(
                new ResourceLocation(Frostbite.MODID, "preboss_shot"),
    ...
    private static void register(Frostbite mod, Class<? extends Entity> type, String name, int id) {
        EntityRegistry.registerModEntity(
                new ResourceLocation(Frostbite.MODID, name),
                type,
                name,
                id,
                mod,
    ...
    public static void postInit() {
        ...
        DeepModule.postInit();
        for (Biome b : all)
            if (com.scapeandrun.frostbite.world.FrigidSpawnBiomes.isCold(b))
                EntityRegistry.addSpawn(
