...
public final class ExplorationEvents {
    ...
    private static final String AIR_USED = "FrostbiteBottleJumpMask",
            AIR_TICKS = "FrostbiteBottleAirTicks";
    ...
    public static void tick(TickEvent.PlayerTickEvent event) {
        ...
        double movedX = player.posX - data.getDouble("FrostbiteStrideX"),
                movedZ = player.posZ - data.getDouble("FrostbiteStrideZ");
        boolean running =
                data.hasKey("FrostbiteStrideX")
        ...
        data.setDouble("FrostbiteStrideX", player.posX);
        data.setDouble("FrostbiteStrideZ", player.posZ);
        int stride =
                PrebossRules.runningTicks(
                        data.getInteger("FrostbiteHermesStride"), running, player.onGround);
        data.setInteger("FrostbiteHermesStride", stride);
        ...
        event.getTable()
                .addPool(
                        new LootPool(
                                ...
                                "frostbite_exploration_accessory"));
    }
}
