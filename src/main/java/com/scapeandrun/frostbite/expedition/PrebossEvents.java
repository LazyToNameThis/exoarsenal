...
public final class PrebossEvents {
    ...
    public static void hurt(LivingHurtEvent event) {
        if (event.getEntityLiving() instanceof EntityPlayer
            ...
            event.getEntityLiving().getEntityData().setInteger("FrostbiteRegenWait", 100);
            event.getEntityLiving().getEntityData().setInteger("FrostbiteRogueFocus", 0);
        }
    }
    ...
    public static void tick(TickEvent.PlayerTickEvent event) {
        ...
        if (player.ticksExisted % 5 == 0
                && (player.getEntityData().getInteger("LastManaSent") != mana
                        ...
                        || player.getEntityData().getInteger("LastFocusSent")
                                != player.getEntityData().getInteger("FrostbiteRogueFocus")
        ...
        int wait = player.getEntityData().getInteger("FrostbiteRegenWait");
        if (wait > 0) player.getEntityData().setInteger("FrostbiteRegenWait", wait - 1);
        ...
        int focus = player.getEntityData().getInteger("FrostbiteRogueFocus");
        player.getEntityData()
                .setInteger(
                        "FrostbiteRogueFocus",
                        holding
    ...
    public static void herbs(BlockEvent.HarvestDropsEvent event) {
        ...
        if (event.getState().getBlock() == net.minecraft.init.Blocks.TALLGRASS
                && com.scapeandrun.frostbite.world.FrigidSpawnBiomes.isCold(
