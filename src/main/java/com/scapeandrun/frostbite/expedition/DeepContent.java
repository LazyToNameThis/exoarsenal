        ...
        event.getRegistry()
                .register(
                        new ShapelessOreRecipe(
                                        ...
                                        Items.BONE,
                                        Items.BONE)
                                .setRegistryName(Frostbite.MODID, "golden_key"));
        event.getRegistry()
                .register(
                        new ShapelessOreRecipe(
                                        null,
                                        ...
                                        Blocks.OBSIDIAN,
                                        Blocks.OBSIDIAN)
                                .setRegistryName(Frostbite.MODID, "obsidian_brick"));
        event.getRegistry()
                .register(
                        new net.minecraftforge.oredict.ShapedOreRecipe(
                                        ...
                                        'V',
                                        WildContent.VINE)
                                .setRegistryName(Frostbite.MODID, "molten_pickaxe"));
        event.getRegistry()
                .register(
                        new net.minecraftforge.oredict.ShapedOreRecipe(
                                        null,
                                        ...
                                        'V',
                                        WildContent.VINE)
                                .setRegistryName(Frostbite.MODID, "volcano"));
        event.getRegistry()
                .register(
                        new ShapelessOreRecipe(
                                        null,
                                        ...
                                        WildContent.STINGER,
                                        WildContent.VINE)
                                .setRegistryName(Frostbite.MODID, "blade_of_grass"));
    }
