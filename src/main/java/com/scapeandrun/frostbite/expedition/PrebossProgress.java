...
public final class PrebossProgress {
    public static final String KEY = "FrostbitePreboss";
    ...
    public static void sync(EntityPlayer player) {
        if (player instanceof EntityPlayerMP)
            com.scapeandrun.frostbite.network.ModNetwork.CHANNEL.sendTo(
                    new com.scapeandrun.frostbite.network.PacketPrebossMana(
