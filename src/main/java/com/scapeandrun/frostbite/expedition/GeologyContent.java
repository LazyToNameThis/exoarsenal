        ...
        event.getRegistry()
                .register(
                        new net.minecraftforge.oredict.ShapedOreRecipe(
                                        new ResourceLocation(Frostbite.MODID, "geology"),
                                        ...
                                        'C',
                                        "cobblestone")
                                .setRegistryName(Frostbite.MODID, "extractinator"));
        event.getRegistry()
                .register(
                        new net.minecraftforge.oredict.ShapelessOreRecipe(
                                ...
                                .setRegistryName(Frostbite.MODID, "cave_javelin"));
        event.getRegistry()
                .register(
                        new net.minecraftforge.oredict.ShapelessOreRecipe(
                                        new ResourceLocation(Frostbite.MODID, "geology"),
                                ...
                                .setRegistryName(Frostbite.MODID, "mushroom_healing_potion"));
    }
        ...
        for (Ore ore : Ore.values())
            if (!ore.gem) {
                ...
                if (ore.temperature <= 1100)
                    com.scapeandrun.frostbite.tile.TileEntityPotteryKiln
                            .registerLowTemperatureMetalRecipe(
