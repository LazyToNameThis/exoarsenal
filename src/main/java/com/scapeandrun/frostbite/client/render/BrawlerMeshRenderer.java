...
import com.scapeandrun.frostbite.client.BrawlerJetpack;
import com.scapeandrun.frostbite.client.BrawlerSkin;
    ...
    public static void draw(ExpeditionMesh mesh, int part, boolean jetpack) {
        if (jetpack) {
            ...
            Minecraft.getMinecraft()
                    .getTextureManager()
                    .bindTexture(WholeModelTexture.get("brawler_thrusters"));
        ...
        if (part >= 0) {
            ...
            Minecraft.getMinecraft()
                    .getTextureManager()
                    .bindTexture(WholeModelTexture.get("brawler"));
