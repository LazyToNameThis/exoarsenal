...
import com.scapeandrun.frostbite.item.ItemScoutEnergyCore;
...
public final class ScoutCoreRenderer extends GeoItemRenderer<ItemScoutEnergyCore> {
    ...
    private static final class CoreModel extends AnimatedGeoModel<ItemScoutEnergyCore> {
        public ResourceLocation getModelLocation(ItemScoutEnergyCore i) {
            return new ResourceLocation(Frostbite.MODID, "geo/scout_energy_core.geo.json");
        }
            ...
            if (mc.player != null)
                for (com.scapeandrun.frostbite.entity.EntityScoutCoreRay ray :
                    ...
                    if (ray.belongs(mc.player))
                        charge =
                                com.scapeandrun.frostbite.entity.ScoutCoreMotion.charge(
