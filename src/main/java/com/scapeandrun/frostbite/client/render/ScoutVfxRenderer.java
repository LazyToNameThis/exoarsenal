...
public final class ScoutVfxRenderer {
    ...
    public static void render(float partialTicks) {
        ...
        for (Entity entity : mc.world.loadedEntityList) {
            ...
            else if (entity instanceof com.scapeandrun.frostbite.entity.EntityFrigidRobot)
                renderRobot(
                        (com.scapeandrun.frostbite.entity.EntityFrigidRobot) entity, partialTicks);
        }
    ...
    private static void renderRobot(
            com.scapeandrun.frostbite.entity.EntityFrigidRobot robot, float partial) {
        ...
        boolean ranged =
                robot.kind() == com.scapeandrun.frostbite.entity.EntityFrigidRobot.Kind.DRONE
                        || robot.kind()
                                        == com.scapeandrun.frostbite.entity.EntityFrigidRobot.Kind
                                                .ROVER
                                && robot.attack() == 1
                        || robot.kind()
                                        == com.scapeandrun.frostbite.entity.EntityFrigidRobot.Kind
                    ...
                    robot.kind()
                            ...
                            : robot.kind()
                                                    == com.scapeandrun.frostbite.entity
                                                            .EntityFrigidRobot.Kind.AMPLIFIER
                                            || robot.attack() == 3
                                    ? 5
                                    : 3;
    ...
    private static void renderScout(EntityX20Scout scout, float partial) {
        ...
        if (attack == ScoutCombatPattern.RANGE_REEL
                && tick < com.scapeandrun.frostbite.entity.ScoutRangeReel.WINDUP)
    ...
    private static void renderExpert(EntityX20Scout scout, float partial) {
        ...
        com.scapeandrun.frostbite.entity.EntityScoutArena arena = scout.arena();
        if (arena != null
                && (a == ScoutCombatPattern.EXPERT_WEB
                        || a == ScoutCombatPattern.EXPERT_PENDULUM)) {
            for (boolean right : new boolean[] {false, true})
                if (com.scapeandrun.frostbite.entity.ScoutViceMotion.extension(a, t, right) > .001)
                    iceChain(
        ...
        if (a == ScoutCombatPattern.EXPERT_FREEFALL
                && com.scapeandrun.frostbite.entity.ScoutViceMotion.extension(a, t, true) > .001)
            iceChain(
