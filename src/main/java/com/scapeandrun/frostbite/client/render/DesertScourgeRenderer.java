...
public final class DesertScourgeRenderer extends Render<EntityDesertScourge>
    ...
    public ResourceLocation getTextureLocation(EntityDesertScourge e) {
        return com.scapeandrun.frostbite.expedition.client.PixelTextures.location(1);
    }
    ...
    public void renderRecursively(
        ...
        if ((n.equals("head") || n.equals("body") || n.equals("tail")) && !n.equals(section))
            return;
        int c = com.scapeandrun.frostbite.client.DesertScourgePalette.color(n);
        java.util.List<com.scapeandrun.frostbite.client.DesertScourgeMesh.Quad> mesh =
                com.scapeandrun.frostbite.client.DesertScourgeMesh.part(n);
        if (mesh != null) {
            ...
            for (com.scapeandrun.frostbite.client.DesertScourgeMesh.Quad q : mesh) {
    ...
    private static final class Model extends AnimatedGeoModel<EntityDesertScourge> {
        public ResourceLocation getModelLocation(EntityDesertScourge e) {
            return new ResourceLocation(Frostbite.MODID, "geo/desert_scourge.geo.json");
        }
        ...
        public ResourceLocation getAnimationFileLocation(EntityDesertScourge e) {
            return new ResourceLocation(
                    Frostbite.MODID, "animations/desert_scourge.animation.json");
        }
    }
}
