...
import com.scapeandrun.frostbite.entity.EntityPersonalMachine;
import com.scapeandrun.frostbite.registry.MachineRewards;
import com.scapeandrun.frostbite.client.render.ExcavatorRenderer;
    ...
    private static final class MachineRenderer extends Render<EntityPersonalMachine> {
        ...
        public void doRender(
            ...
            if (!e.mount() && e.action() > 0 && e.beamTarget() != null) {
                ...
                com.scapeandrun.frostbite.client.render.WulfrumRayRenderer.begin();
                BufferBuilder b = Tessellator.getInstance().getBuffer();
                b.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_COLOR);
                com.scapeandrun.frostbite.client.render.WulfrumRayRenderer.tube(
                        b,
                ...
                com.scapeandrun.frostbite.client.render.WulfrumRayRenderer.finish();
                GlStateManager.popMatrix();
            }
        }
    }
    ...
    private static final class Icon extends TileEntityItemStackRenderer {
        ...
        public void renderByItem(ItemStack stack, float partial) {
            ...
            Minecraft.getMinecraft()
                    .getTextureManager()
                    .bindTexture(WholeModelTexture.get("excavator"));
