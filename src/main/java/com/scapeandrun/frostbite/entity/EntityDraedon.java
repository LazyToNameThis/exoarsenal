...
import com.scapeandrun.frostbite.expedition.ExpeditionContent;
...
@net.minecraftforge.fml.common.Mod.EventBusSubscriber(
        modid = com.scapeandrun.frostbite.Frostbite.MODID)
public final class EntityDraedon extends EntityLiving {
    ...
    private void choose(EntityPlayer player) {
        ...
        player.sendMessage(line);
        player.openGui(
                com.scapeandrun.frostbite.Frostbite.INSTANCE,
                1,
                world,
                terminal.getX(),
                terminal.getY(),
