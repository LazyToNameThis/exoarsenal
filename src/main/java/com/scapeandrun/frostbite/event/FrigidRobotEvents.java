...
public final class FrigidRobotEvents {
    ...
    public static void weather(
        ...
        if (event.phase == net.minecraftforge.fml.common.gameevent.TickEvent.Phase.END
            ...
            FrostbiteWorldSettings.get(event.world).consumeRobotKills();
    }
    ...
    public static void defeated(LivingDeathEvent event) {
        if (!event.getEntityLiving().world.isRemote
            ...
            if (owner instanceof com.scapeandrun.frostbite.entity.EntityX20Scout)
                ((com.scapeandrun.frostbite.entity.EntityX20Scout) owner)
                        .waveMemberDefeated(event.getEntityLiving().getUniqueID());
            else
                com.scapeandrun.frostbite.world.ScoutEncounterLedger.get(
        ...
        if (!com.scapeandrun.frostbite.world.FrigidSpawnBiomes.isCold(
                player.world.getBiome(player.getPosition()))) return;
        FrostbiteWorldSettings settings = FrostbiteWorldSettings.get(player.world);
