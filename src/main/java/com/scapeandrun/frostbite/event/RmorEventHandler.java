...
public class RmorEventHandler {
    ...
    private static final String DEFENSE_FORM = "FrostbiteRmorDefenseForm";
    ...
    private static void defenseJump(EntityPlayer player) {
        ...
        if (player.onGround
                || data.getBoolean("FrostbiteDefenseDoubleJump")
        ...
        data.setBoolean("FrostbiteDefenseDoubleJump", true);
    ...
    public void poweredMovement(TickEvent.PlayerTickEvent event) {
        ...
        if (player.onGround) data.setBoolean("FrostbiteDefenseDoubleJump", false);
