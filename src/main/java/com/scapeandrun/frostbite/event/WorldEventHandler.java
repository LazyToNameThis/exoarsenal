...
public class WorldEventHandler {
    ...
    public void cancelTrees(DecorateBiomeEvent.Decorate event) {
        if (ModConfig.removeAllTreeGeneration
                && com.scapeandrun.frostbite.world.FrozenWorldRules.isFrozenWasteland(
                        event.getWorld())
    ...
    public void scrubChunk(PopulateChunkEvent.Post event) {
        ...
        if (!com.scapeandrun.frostbite.world.FrozenWorldRules.isFrozenWasteland(world)) return;
    ...
    public void permanentSnow(TickEvent.WorldTickEvent event) {
        if (event.phase != TickEvent.Phase.END
                ...
                || !com.scapeandrun.frostbite.world.FrozenWorldRules.isFrozenWasteland(event.world)
